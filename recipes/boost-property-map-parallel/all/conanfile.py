...
class BoostProperty_Map_ParallelRecipe(ConanFile):
    ...
    def package(self):
        ...
        copy(
            ...
            self.source_folder,
            os.path.join(
                self.package_folder, 'share', 'boost', 'property_map_parallel',
            ),
        )
    ...
    def package_info(self):
        ...
        self.cpp_info.set_property('b2_project_name', '/boost/property-map-parallel')