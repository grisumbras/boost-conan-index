...
class BoostStl_InterfacesRecipe(ConanFile):
    ...
    def package(self):
        ...
        copy(
            ...
            self.source_folder,
            os.path.join(
                self.package_folder, 'share', 'boost', 'stl_interfaces',
            ),
        )
    ...
    def package_info(self):
        ...
        self.cpp_info.set_property('b2_project_name', '/boost/stl-interfaces')