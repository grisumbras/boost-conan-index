...
class BoostNumeric_ConversionRecipe(ConanFile):
    ...
    def package(self):
        ...
        copy(
            ...
            self.source_folder,
            os.path.join(
                self.package_folder, 'share', 'boost', 'numeric_conversion',
            ),
        )
    ...
    def package_info(self):
        ...
        self.cpp_info.set_property('b2_project_name', '/boost/numeric-conversion')